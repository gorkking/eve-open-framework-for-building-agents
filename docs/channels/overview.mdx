...
Install a channel from the registry with `eve add channel/photon-imessage`, `eve add channel/sendblue`, `eve add channel/slack`, or `eve add channel/web`. You can also author the file by hand.
