...
const Author = ({ compact = false, post }: { compact?: boolean; post: BlogPost }) => (
...
export const BlogPostLayout = ({ children, post }: BlogPostLayoutProps) => {
  const postUrl = `https://eve.dev${post.href}`;
