...
/**
 * The join contract that replaced `task_await`: the framework delivers one
...
export default defineEval({
  ...
  async test(t) {
    ...
    waiting.turn.calledTool("task_peek", { input: { taskIds: [/task_/, /task_/] } });
    ...
    complete.turn.calledTool("task_peek");
    t.noFailedActions();
  },
});
