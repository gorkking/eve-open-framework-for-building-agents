...
import type { DevelopmentGeneration } from "#internal/host/development-generation.js";
import type { DevelopmentHostWorkspace } from "#internal/host/dev-host-workspace.js";
import type { DevelopmentWorkspaceExtension } from "#internal/host/dev-workspace-extensions.js";
...
/** Outcome of starting a development server the current process owns. */
...
/**
 * Lifecycle for one in-process development server.
 *
...
/**
 * Handle returned after starting one built server.
 */
