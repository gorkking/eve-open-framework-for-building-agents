...
vi.mock("#internal/host/dev-runtime-artifacts.js", async () => {
  const actual = await vi.importActual<typeof import("#internal/host/dev-runtime-artifacts.js")>(
    "#internal/host/dev-runtime-artifacts.js",
  );
  return {
    ...actual,
...
describe("resolveAgentInfoCompiledArtifactsSource", () => {
  it("uses dev runtime snapshot artifacts without the authored-source module loader", async () => {
    const { resolveAgentInfoCompiledArtifactsSource } =
      await import("#internal/host/routes/agent-info/load-agent-info-data.js");
