...
import { computeApplicationChannelRouteRegistrations } from "#internal/host/application-route-registry.js";
...
export async function computeDevelopmentHostFingerprint(
  ...
  const payload = {
    ...
    channels: computeApplicationChannelRouteRegistrations(host),
