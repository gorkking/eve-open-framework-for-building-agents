...
import { resolveDevelopmentRuntimeArtifactsPointerPath } from "#internal/host/dev-runtime-artifacts.js";
import type {
 ...
 */
export function createDevelopmentApplicationArtifactsConfig(input: {
 ...
 */
export function createProductionApplicationArtifactsConfig(): ProductionApplicationArtifactsConfig {
  return {
    kind: "production",
  };
}
