...
} from "#internal/host/dev-runtime-source-snapshot.js";
...
vi.mock("#internal/host/build-extension.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("#internal/host/build-extension.js")>()),
  buildExtensionPackage: mocks.buildExtensionPackage,
}));

import { prepareDevelopmentWorkspaceExtensions } from "#internal/host/dev-workspace-extensions.js";
