...
} from "#internal/host/dev-runtime-source-snapshot-local-roots.js";

export { isAuthoredSourcePath } from "#internal/host/dev-runtime-source-snapshot-local-roots.js";
