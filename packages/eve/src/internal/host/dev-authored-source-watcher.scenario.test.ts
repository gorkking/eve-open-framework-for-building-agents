...
import type { DevelopmentAuthoredRebuildCoordinator } from "#internal/host/dev-authored-rebuild-coordinator.js";
import type { PreparedDevelopmentApplicationHost } from "#internal/host/types.js";
import { STRUCTURAL_RELOAD_LOG_LINE } from "#internal/host/dev-watcher-log.js";
...
import { startAuthoredSourceWatcher } from "#internal/host/dev-authored-source-watcher.js";
...
function createPreparedHost(
  ...
  return {
    ...
    workspace: {
      ...
      hostBuildDir: join(appRoot, ".eve", "dev-hosts", "test", "host"),
      hostOutputDir: join(appRoot, ".eve", "dev-hosts", "test", "output"),
