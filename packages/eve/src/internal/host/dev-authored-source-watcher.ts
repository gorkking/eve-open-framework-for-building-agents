...
import { resolveDevelopmentSourceSnapshotWatchPaths } from "#internal/host/dev-runtime-source-snapshot.js";
 ...
 * triggers worker reloads only when structural runtime wiring changes.
 */
