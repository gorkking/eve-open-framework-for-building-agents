...
} from "#internal/host/dev-host-workspace.js";
import {
  prepareDevelopmentWorkspaceExtensions,
  type DevelopmentWorkspaceExtension,
} from "#internal/host/dev-workspace-extensions.js";
import type {
 ...
 * stages the package-owned artifacts the production host build needs.
